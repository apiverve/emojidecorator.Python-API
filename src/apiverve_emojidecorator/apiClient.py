...
class EmojidecoratorAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the EmojidecoratorAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/emojidecorator'
        self.headers = {
